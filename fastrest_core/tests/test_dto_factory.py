"""
Unit tests for fastrest_core.dto.factory (generate_dtos / DTOSet)
and fastrest_core.dto.pagination (paged_response / PagedReadDTO / PageCursor).
...
from fastrest_core.dto.base import UpdateOperation
...
from fastrest_core.meta import FieldHint, PKStrategy, PrimaryKey, pk_field
