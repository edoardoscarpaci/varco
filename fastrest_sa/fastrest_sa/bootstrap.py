"""
fastrest_sa.bootstrap
======================
One-stop bootstrap for SQLAlchemy + fastrest applications.
...
from fastrest_sa.schema_guard import SchemaGuard, SchemaDriftReport
...
class SAConfig:
    """
    Immutable configuration for an SA-backed fastrest application.
...
class SAFastrestApp:
    """
    Bootstrap coordinator for SQLAlchemy + fastrest applications.
