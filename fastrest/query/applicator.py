...
class QueryApplicator(ABC):
    ...
    @abstractmethod
    def apply_pagination(self, query : _T, limit : Optional[int] , offset : Optional[int], *args,**kwargs)->_T:
        pass

    @abstractmethod
    def apply_sort(self, query : _T,filters : List[SortField] = list(), *args,**kwargs)->_T:
        pass
