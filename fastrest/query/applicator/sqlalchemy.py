...
class SQLAlchemyQueryApplicator(QueryApplicator):
    def __init__(self,model_cls : DeclarativeBase,*args,query_compiler : Optional[SQLAlchemyQueryCompiler] = None,**kwargs):
        self.model_cls = model_cls
        if query_compiler is not None and not isinstance(query_compiler,SQLAlchemyQueryCompiler):
            raise ValueError("query_compiler must be an instance of SQLAlchemyQueryCompiler or its one of its subclasses")
