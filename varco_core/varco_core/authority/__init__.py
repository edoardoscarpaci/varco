...
**Key sources (used internally or for custom config):**
    ...
    from varco_core.authority.sources import (
        IssuerSource,
        PemFileSource,
        PemFolderSource,
        JwksUrlSource,
...
**Configuration:**
    ...
    from varco_core.authority import AuthorizationConfig
...
from varco_core.authority.config import AuthorizationConfig, IssuerConfig
